...
function showVideoPlayer(url, type) {
  ...
  // ─── VIDEO CÓ BÓNG TO LỆCH XUỐNG DƯỚI VÀ SANG PHẢI ───
  video.style.cssText = 'max-width:100%; max-height:100%; width:100%; height:100%; display:block; object-fit:contain; border-radius:12px; box-shadow:8px 12px 30px rgba(0,0,0,0.7), -2px -2px 10px rgba(255,255,255,0.05);';
