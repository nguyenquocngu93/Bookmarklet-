/**
 * Universal Media Player & Downloader - V6.8.0 PRO
 * - MỚI: Player dạng thẻ nổi bo góc (không còn phủ đen toàn màn hình) — chỉ
 *   còn video + thanh tua, nổi giữa trang web, trang gốc vẫn nhìn thấy xung quanh.
 * - MỚI: gộp toàn bộ header/toolbar cũ vào 1 nút menu (⋮) duy nhất ở góc phải
 *   trên video, bấm để mở/đóng bảng tính năng (chất lượng, tốc độ, PiP, hẹn
 *   giờ, boost âm lượng, phụ đề, tải xuống...).
 * - MỚI: tự ẩn UI chính của script (panel __uvd__) khi đang phát video, hiện
 *   lại khi đóng player.
