/**
 * Universal Video Downloader V3.4 — Clean Preview + Vertical Accent
 * Fixes: Tiny corner status, Quality bar on top, More blur, No icon buttons,
 *        Vertical accent bar before titles
...
(function() {
    ...
    var themes = {
        'glass-dark': {
            name: 'Glass Dark',
            bg: 'rgba(10, 10, 16, 0.85)',
            bg2: 'rgba(20, 20, 30, 0.8)',
            bg3: 'rgba(30, 30, 45, 0.65)',
            ...
            text3: '#787890',
            primary: '#7C6CFF',
            primaryGlow: 'rgba(124, 108, 255, 0.4)',
            accent: '#00E5FF',
        ...
        'glass-purple': {
            ...
            glassBorder: 'rgba(187, 134, 252, 0.18)',
            text: '#ffffff',
            text2: '#d0b8f8',
            text3: '#8868a8',
            primary: '#C084FC',
    ...
    function buildUI() {
        ...
        panel.innerHTML = 
            '<div class="__uvd_header__">' +
                '<div class="__uvd_accent_bar__"></div>' +
                '<div class="__uvd_header_left__">' +
                    '<div class="__uvd_header_text__">' +
                        '<div class="__uvd_title__">Universal DL <span class="__uvd_version__">V3.4</span></div>' +
            ...
            '<div class="__uvd_body__">' +
                ...
                '<div class="__uvd_tabs__">' +
                    '<button class="__uvd_tab__ active" data-tab="video">Video <span class="__uvd_badge__">' + videoCount + '</span></button>' +
                    '<button class="__uvd_tab__" data-tab="photo">Photo <span class="__uvd_badge__">' + photoCount + '</span></button>' +
                    ...
                    '<button class="__uvd_tab__" data-tab="settings">Settings</button>' +
                '</div>' +
                
                '<div class="__uvd_info_bar__">' +
                    '<div class="__uvd_info_row__">' +
                        '<span class="__uvd_info_label__">Title:</span>' +
    ...
    function getGlobalCSS(t) {
        ...
        '.__uvd_panel__ {' +
            ...
            'overflow: hidden;' +
            'box-shadow: 0 0 40px rgba(0,0,0,0.6), inset 0 1px 0 ' + t.glassBorder + ';' +
        ...
        '.__uvd_accent_bar__ {' +
            ...
            'box-shadow: 0 0 10px ' + t.primaryGlow + ';' +
        '}' +
        '.__uvd_header_left__ { display: flex; align-items: center; gap: 10px; min-width: 0; flex: 1; margin-left: 10px; }' +
        ...
        '.__uvd_live_dot__ { width: 5px; height: 5px; background: ' + t.success + '; border-radius: 50%; display: inline-block; animation: uvdPulse 1.5s infinite; flex-shrink: 0; box-shadow: 0 0 6px ' + t.success + '; }' +
        ...
        '.__uvd_sort_select__ {' +
            ...
            'color: ' + t.text + '; padding: 8px 10px; border-radius: 8px; font-size: 11px; outline: none;' +
            'backdrop-filter: blur(8px);' +
        '}' +
        
        '.__uvd_tabs__ {' +
            'display: flex; background: ' + t.bg2 + '; backdrop-filter: blur(12px);' +
            '-webkit-backdrop-filter: blur(12px);' +
            'padding: 6px; gap: 4px;' +
        ...
        '.__uvd_tab__ {' +
            ...
            'border: 1px solid transparent; padding: 7px 12px; border-radius: 8px;' +
        ...
        '.__uvd_tab__.active {' +
            'background: linear-gradient(135deg, ' + t.primary + '30, ' + t.accent + '15);' +
            'color: ' + t.text + ';' +
        ...
        '.__uvd_info_label__ { opacity: 0.7; font-weight: 600; color: ' + t.text2 + '; }' +
        ...
        '.__uvd_card__::before {' +
            ...
            'opacity: 0.7;' +
        '}' +
        '.__uvd_card_header__ { display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px; gap: 8px; padding-left: 8px; }' +
        ...
        '.__uvd_act_btn__ {' +
            'border: 0; padding: 10px 6px; border-radius: 8px; font-size: 11px; font-weight: 600;' +
        ...
        '.__uvd_footer__ {' +
            'background: ' + t.bg2 + '; backdrop-filter: blur(16px);' +
        ...
        '.__uvd_footer_btn__ {' +
            'background: ' + t.glass + '; border: 1px solid ' + t.glassBorder + ';' +
            'color: ' + t.text + '; padding: 8px 10px; border-radius: 8px; font-size: 11px; font-weight: 600;' +
        ...
        '}' +
        '.__uvd_overlay_box__ {' +
            'background: ' + t.bg + '; backdrop-filter: blur(24px) saturate(160%);' +
            '-webkit-backdrop-filter: blur(24px) saturate(160%);' +
            'border: 1px solid ' + t.glassBorder + ';' +
            'border-radius: 16px; padding: 16px; width: 100%; max-width: 600px; margin: auto;' +
            'box-shadow: 0 20px 60px rgba(0,0,0,0.6), inset 0 1px 0 ' + t.glassBorder + ';' +
        '}' +
        ...
        '.__uvd_overlay_title__::before {' +
            'content: ""; width: 3px; height: 18px;' +
            'background: linear-gradient(to bottom, ' + t.primary + ', ' + t.accent + ');' +
            'border-radius: 2px; box-shadow: 0 0 8px ' + t.primaryGlow + ';' +
        '}' +
        
        '.__uvd_quality_card__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(8px); padding: 14px; margin-bottom: 10px; border-radius: 12px; position: relative; }' +
        '.__uvd_quality_card__::before {' +
            'content: ""; position: absolute; left: 0; top: 20%; bottom: 20%; width: 3px;' +
            'background: linear-gradient(to bottom, ' + t.primary + ', ' + t.accent + '); border-radius: 0 2px 2px 0;' +
        '}' +
        '.__uvd_quality_header__ { display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px; padding-left: 8px; }' +
        '.__uvd_quality_label__ { color: ' + t.primary + '; font-size: 15px; font-weight: 700; }' +
        '.__uvd_quality_info__ { color: ' + t.text3 + '; font-size: 10px; margin-bottom: 10px; padding-left: 8px; }' +
        
        '.__uvd_cmd_card__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(8px); padding: 14px; margin-bottom: 10px; border-radius: 12px; position: relative; }' +
        '.__uvd_cmd_card__::before {' +
            'content: ""; position: absolute; left: 0; top: 20%; bottom: 20%; width: 3px;' +
            'background: linear-gradient(to bottom, ' + t.warning + ', ' + t.primary + '); border-radius: 0 2px 2px 0;' +
        '}' +
        '.__uvd_cmd_label__ { color: ' + t.warning + '; font-weight: 600; margin-bottom: 8px; font-size: 12px; padding-left: 8px; }' +
        '.__uvd_cmd_code__ {' +
        ...
        '.__uvd_settings_section__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(8px); padding: 14px; margin-bottom: 12px; border-radius: 12px; position: relative; }' +
        '.__uvd_settings_section__::before {' +
            'content: ""; position: absolute; left: 0; top: 20%; bottom: 20%; width: 3px;' +
            'background: linear-gradient(to bottom, ' + t.primary + ', ' + t.accent + '); border-radius: 0 2px 2px 0;' +
        '}' +
        '.__uvd_settings_title__ { color: ' + t.text + '; font-weight: 700; margin-bottom: 12px; font-size: 14px; padding-left: 10px; }' +
        ...
        /* ========== PREVIEW PLAYER - FIX OVERLAP + TINY STATUS ========== */
        ...
        /* TINY CORNER STATUS - bottom left, small pill */
        '.__uvd_preview_status__ {' +
            'position: absolute; bottom: 70px; left: 12px; z-index: 8;' +
        ...
        /* Quality bar - AT TOP under header, scrollable, no overlap */
        ...
        /* Preview buttons - NO ICON, text only */
        '.__uvd_preview_btn__ {' +
        ...
        '.__uvd_preview_btn__.active { background: ' + t.primary + '; border-color: ' + t.primary + '; box-shadow: 0 0 12px ' + t.primaryGlow + '; }' +
        
        /* Landscape */
        '@media (orientation: landscape) {' +
            '.__uvd_preview_video__ { width: 100vw; height: 100vh; }' +
            '.__uvd_preview_controls__ { padding: 8px 12px; }' +
            '.__uvd_preview_status__ { bottom: 60px; left: 10px; }' +
        ...
        '.__uvd_history_item__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(6px); padding: 10px 12px; margin-bottom: 6px; border-radius: 10px; position: relative; }' +
        '.__uvd_history_item__::before {' +
            'content: ""; position: absolute; left: 0; top: 25%; bottom: 25%; width: 3px;' +
            'background: ' + t.accent + '; border-radius: 0 2px 2px 0; opacity: 0.6;' +
        '}' +
        '.__uvd_history_title__ { color: ' + t.text + '; font-size: 11px; font-weight: 600; margin-bottom: 3px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; padding-left: 8px; }' +
        '.__uvd_history_meta__ { color: ' + t.text3 + '; font-size: 9px; padding-left: 8px; }' +
        '.__uvd_history_url__ { color: ' + t.text2 + '; font-size: 9px; font-family: monospace; word-break: break-all; max-height: 25px; overflow: hidden; padding-left: 8px; }' +
        
        '.__uvd_fav_card__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(6px); padding: 14px; margin-bottom: 10px; border-radius: 12px; border-left: 3px solid gold; }' +
    ...
    function showQualityPicker(url) {
        ...
        overlay.innerHTML = 
            '<div class="__uvd_overlay_box__">' +
                '<div class="__uvd_overlay_title__">Đang phân tích M3U8...</div>' +
            ...
            qualities.forEach(function(q) {
                ...
                html += 
                    '<div class="__uvd_quality_card__">' +
                        ...
                        '<div class="__uvd_actions__">' +
                            '<button class="__uvd_act_btn__ __uvd_btn_preview__" data-url="' + encodeURIComponent(q.url) + '" data-action="preview">Preview</button>' +
                            ...
                            '<button class="__uvd_act_btn__ __uvd_btn_cmd__" data-url="' + encodeURIComponent(q.url) + '" data-action="cmd">Lệnh</button>' +
                        '</div>' +
                    '</div>';
            });
    ...
    // ========== PREVIEW PLAYER - TINY CORNER STATUS + QUALITY ON TOP ==========
    function showPreview(url, type) {
        ...
        overlay.innerHTML = 
            ...
            '<div class="__uvd_preview_controls__" id="__pv_controls__">' +
                ...
                '<button class="__uvd_preview_btn__" id="__pv_cmd__">Lệnh tải</button>' +
                '<button class="__uvd_preview_btn__" id="__pv_quality__">Quality</button>' +
        ...
        video.addEventListener('playing', function() { showStatus('Đang phát', 1200); showUI(); });
        ...
        video.addEventListener('error', function() { showStatus('Lỗi phát video', 2500); });
        video.addEventListener('ended', function() { showStatus('Đã phát xong', 1500); showUI(); });
        ...
        function loadHls() {
            if (window.Hls) { initHls(); }
                ...
                hlsScript.onerror = function() { showStatus('Lỗi load HLS.js', 2500); video.src = url; };
        ...
        function initHls() {
            if (Hls.isSupported()) {
                ...
                currentHls.on(Hls.Events.ERROR, function(event, data) {
                    if (data.fatal) {
                        showStatus('Lỗi: ' + data.details, 2500);
                        switch(data.type) {
    ...
    function showCommandPicker(url, type) {
        ...
        var overlay = document.createElement('div');
        overlay.className = '__uvd_overlay__';
        var html = '<div class="__uvd_overlay-box__"><div class="__uvd_overlay_title__">Chọn lệnh tải</div>';
    ...
    function showEditor(text, title) {
        ...
        overlay.innerHTML = 
            '<div class="__uvd_overlay-box__">' +
                '<div class="__uvd_overlay_title__">' + escapeHtml(title) + '</div>' +
    ...
    function renderSettings(container) {
        ...
        html += '<div class="__uvd_settings_section__"><div class="__uvd_settings_title__">Thông tin</div>' +
            '<div style="color:' + t.text2 + ';font-size:10px;line-height:1.7;padding-left:10px;">' +
            '<div>Version: 3.4 — Clean UI</div>' +
    ...
    buildUI();
    startAutoRefresh();
    console.log('✅ Universal DL V3.4 loaded! Found', urls.size, 'streams initially');
    toast('V3.4 Ready!', 'success');
})();