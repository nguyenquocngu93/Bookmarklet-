/**
 * Universal Video Downloader V3.5 – Glass Pro + Minimize & Auto-Rotate
 * - Minimize to floating button
 * - Fullscreen with forced landscape orientation
 * - All animations, ripple, glass UI from V3.3
...
(function() {
    ...
    // ========== PRO PLAYER (với fullscreen landscape) ==========
    ...
    style.textContent = `
        ...
        .uvd-player-panel { max-width:900px; padding:0; overflow:hidden; }
        .uvd-player-header {
    ...
    function buildUI() {
        ...
        header.innerHTML = 
            '<div style="display:flex;align-items:center;gap:8px;">' +
                ...
                '<span style="font-weight:700;font-size:16px;">Universal DL <span style="color:var(--accent);">V3.5</span></span>' +
            '</div>' +
    ...
    function renderSettings(container) {
        container.innerHTML = 
            ...
            '<div class="uvd-card" style="margin-top:10px;font-size:12px;color:var(--text2);">' +
                'Version 3.5 · nguyenquocngu93<br>' +
    ...
    console.log('Universal DL V3.5 Minimize & Landscape ready – ' + urls.size + ' streams');
    toast('V3.5 Ready');
