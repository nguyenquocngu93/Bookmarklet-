...
function showVideoPlayer(url, type) {
  ...
  // Không ẩn panel chính – overlay sẽ đè lên
  // Giữ reduceMotion như cũ
  ...
  // Sheet – trượt lên, nền hồng nhẹ, ít trong suốt hơn
  var sheet = document.createElement('div');
  sheet.className = 'uvd-settings-sheet';
  sheet.style.cssText = 'display:flex; flex-direction:column; height:92dvh; max-height:92dvh; overflow:hidden; box-sizing:border-box; background:rgba(40,20,30,0.96); backdrop-filter:blur(16px); -webkit-backdrop-filter:blur(16px);';
  ...
  sheetHeader.style.cssText = 'flex-shrink:0; flex-direction:column; align-items:stretch; gap:2px; background:transparent;';
  ...
  // Kích hoạt hiệu ứng trượt lên (giống settings)
