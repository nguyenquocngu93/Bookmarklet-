 ...
 * - Header panel chính: ▶ ⏭ ⚙ ↻ × (giữ nút Cài đặt, bỏ ▼)
 * - Giữ tab "Trình phát" với đầy đủ cài đặt
 * - Player card: glass-panel bo góc đều, video full, không khuyết dưới
...
`;
  ...
  // ========== START ==========
  buildUI();
  console.log('V' + VERSION + ' UMP DL PRO - Giữ nút ⚙, bỏ ▼');
