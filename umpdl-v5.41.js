...
@keyframes uvdMinimizeOut{from{transform:scale(1);opacity:1}to{transform:scale(0.8);opacity:0}}
@keyframes uvdMinimizeIn{from{transform:scale(0.8);opacity:0}to{transform:scale(1);opacity:1}}
...
function buildUI() {
  ...
  author.textContent = '© nguyenquocngu93';
    ...
    <div class="uvd-card">
      ...
      <div style="margin-bottom:10px;">
        ...
        <div style="background:rgba(0,0,0,0.5);border-radius:8px;padding:10px;font-family:monospace;font-size:10px;word-break:break-all;border:1px solid var(--border);margin:4px 0;">
          javascript:(function(){var s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/nguyenquocngu93/bookmarklet-@main/umpdl.js?force='+Date.now();document.head.appendChild(s);})();
        </div>
        ...
        <div style="font-size:12px;color:var(--accent2);margin-top:6px;">
          <strong>🔁 Force update:</strong> Bookmarklet trên có <code>?force=`+Date.now()</code> để tránh cache.
        </div>
      </div>
