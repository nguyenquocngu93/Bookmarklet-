 ...
 * - Tối ưu code, loại bỏ trùng lặp auto-click
 * - Ngăn video gốc tự phát (guard interval)
 * - Panel căn giữa màn hình
 * - Giao diện filter quảng cáo đẹp hơn (icon Ad)
...
// ========== AUTO-CLICK PLAY (GỘP CHUNG, KHÔNG TRÙNG LẶP) ==========
...
// ========== BUILD UI (CSS gọn, panel căn giữa) ==========
...
function buildUI() {
  ...
  panel.style.cssText = 'position:fixed;top:15px;bottom:15px;left:50%;transform:translateX(-50%);width:calc(100% - 30px);max-width:1000px;z-index:2147483647;animation:uvdScaleIn 0.4s ease;';
...
console.log('V6.2 UMP DL - Tối ưu, chặn video gốc, căn giữa, filter đẹp');
toast('V6.2 sẵn sàng!');
