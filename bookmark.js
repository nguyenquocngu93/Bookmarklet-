...
.uvd-digging-overlay.uvd-dig-found .uvd-dig-title{color:#b85dc8}.uvd-digging-overlay.uvd-dig-found .uvd-dig-enter-btn{max-height:54px;margin-top:16px;padding:14px 16px;opacity:1}.uvd-digging-overlay.uvd-dig-found .uvd-dig-dirt{animation-play-state:paused;opacity:.38}.uvd-dig-route-hint{max-height:0;margin:0;overflow:hidden;opacity:0;color:#8a6ab0;font-size:11.5px;font-weight:700;line-height:1.4;transition:max-height .28s ease,margin .28s ease,opacity .22s ease}.uvd-digging-overlay.uvd-dig-found .uvd-dig-route-hint{max-height:38px;margin-top:8px;opacity:1}
