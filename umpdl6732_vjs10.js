...
function showVideoPlayer(url, type) {
  ...
  // ─── HEADER (giống hệt header của settings) ───
  ...
  titleSpan.style.cssText = 'flex:1; text-align:center; font-weight:700; font-size:16px; color:var(--accent); text-shadow:0 0 12px rgba(255,47,200,0.5);';
  ...
  // Video có bóng đổ nhẹ + bo góc, và sẽ được set width 95% qua hàm __uvdUpdatePlayerWidth
  video.style.cssText = 'max-width:100%; max-height:100%; width:100%; height:100%; display:block; object-fit:contain; border-radius:12px; box-shadow:0 8px 25px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.05);';
