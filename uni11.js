// ==UserScript==
// @name         DevLib CDN Player - Glass UI Final v5.1
// @namespace    http://tampermonkey.net/
// @version      5.1
// @description  Fixed menu scroll + close
// @author       You
// @match        *://*/*
// @grant        none
...
(function () {
    ...
    function initLogic() {
        ...
        function showMainMenu(e) {
            ...
            // Vị trí menu - hiển thị bên dưới nút Menu
            const btn = $('dlp-pc-menu');
            const r = btn.getBoundingClientRect();
            
            // Kiểm tra không gian bên dưới
            const spaceBelow = window.innerHeight - r.bottom;
            if (spaceBelow > 300 || spaceBelow > window.innerHeight * 0.4) {
            ...
            // Bind menu items với đóng menu sau khi click
        ...
        document.addEventListener('click', (e) => {
            const d = $('dlp-drop');
            if (d.classList.contains('on')) {
                // Check if click is outside dropdown AND not on menu button
