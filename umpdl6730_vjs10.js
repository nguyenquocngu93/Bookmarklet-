...
function showVideoPlayer(url, type) {
  ...
  // ── Đã thêm box-shadow và border-radius ──
  videoWrapper.style.cssText = 'display:flex; align-items:center; justify-content:center; width:100%; height:100%; background:transparent; box-shadow: 4px 4px 20px rgba(0,0,0,0.3), -2px -2px 8px rgba(255,255,255,0.05); border-radius:16px;';
