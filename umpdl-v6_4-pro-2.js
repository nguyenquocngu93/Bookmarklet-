...
function buildUI() {
  ...
  panel.style.cssText = 'position:fixed;top:15px;left:15px;right:15px;bottom:15px;z-index:2147483647;animation:uvdScaleIn 0.4s ease;overscroll-behavior:contain;transform:translateZ(0);-webkit-transform:translateZ(0);will-change:transform;';
...
// Chrome mobile: khi kéo tới cuối trang hoặc thanh địa chỉ ẩn/hiện, visual viewport
// lệch khỏi layout viewport khiến panel position:fixed bị "nhảy"/vỡ hình, đặc biệt
// lúc đang thu nhỏ (panel nhỏ, dễ thấy lệch). Bù lại bằng offsetTop của visualViewport.
