 ...
 * - FIX: chế độ hiệu suất không bị trong suốt, thu nhỏ panel đưa header xuống đáy
...
/* Sửa: khi minimize, đảo ngược flex để header xuống đáy */
.uvd-panel-minimized .uvd-panel-content{flex-direction:column-reverse;}
.uvd-panel-minimized .uvd-panel-content #__uvd_header__{margin-bottom:0;margin-top:8px;border-bottom:none;border-top:1px solid var(--border);padding-top:12px;padding-bottom:4px;}
.uvd-reduce-motion .uvd-liquid-bg{animation:none}
.uvd-reduce-motion *{animation:none!important;transition:none!important}
/* Khắc phục trong suốt khi bật hiệu suất: nền đục, chữ sáng */
.uvd-reduce-motion .uvd-glass-panel{backdrop-filter:blur(0px)!important; -webkit-backdrop-filter:blur(0px)!important; background:rgba(10,11,16,0.97)!important; border-color:rgba(255,255,255,0.15);}
...
.uvd-reduce-motion .uvd-glass-panel .uvd-card{background:rgba(255,255,255,0.05);}
