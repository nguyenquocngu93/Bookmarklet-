...
// ========== DOUBLE-TAP GESTURE (chỉ tua nhanh ±10s, không vuốt sáng/âm) ==========
...
function showVideoPlayer(url, type) {
  ...
  // Gắn gesture (chỉ double tap, không vuốt sáng/âm)
...
.uvd-tabbar::-webkit-scrollbar {
  height:4px;
}
.uvd-tabbar::-webkit-scrollbar-thumb {
  background:var(--accent);
  border-radius:4px;
}
.uvd-tabbar::-webkit-scrollbar-track {
  ...
  function renderTab(tabId) {
    ...
    document.querySelectorAll('[data-tab]').forEach(function(t) {
      if (t.dataset.tab === tabId) {
        ...
        moveIndicatorTo(t);
        // cuộn tab vào vùng nhìn thấy nếu cần
