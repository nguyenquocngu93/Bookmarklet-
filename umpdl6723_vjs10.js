...
function showVideoPlayer(url, type) {
  ...
  // Sheet – KHÔNG set inline transform, để CSS xử lý
  var sheet = document.createElement('div');
  sheet.className = 'uvd-settings-sheet';
  // Chỉ set các thuộc tính cần thiết, không đụng đến transform/transition
  ...
  // Kích hoạt hiệu ứng trượt (thêm class uvd-open)
