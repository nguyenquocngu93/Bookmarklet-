...
// ========== PREVIEW IN NEW TAB (FIXED SEEK) ==========
function openPreviewInNewTab(url, type) {
  // Video thường -> mở trực tiếp URL để trình duyệt tự phát, tua được thoải mái
  ...
  // M3U8 -> dùng HLS.js trong trang trung gian, không autoplay, có preload
  if (type === 'M3U8') {
...
// ---------- HẾT PHẦN 1 ----------
// (Tiếp theo sẽ là CSS và buildUI trong tin nhắn kế tiếp)
