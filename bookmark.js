...
function showVideoPlayer(url, type, fromProxy, forceReinit, forceHlsJs, titleOverride) {
  ...
  overlay.className = 'uvd-settings-overlay uvd-player-overlay uvd-player-clean';
  __uvdAppendRoot(overlay);
  ...
  function __uvdApplyPlayerLayout() {
    ...
    playerEl.style.clipPath = fs ? 'none' : 'inset(0 round ' + frameRadius + ')';
    if (skinEl) {
...
#__uvd_player_el__ video-skin,#__uvd_player_el__ video{border-radius:inherit!important}#__uvd_player_el__{background:#fff8fc!important;overflow:hidden!important;border-radius:24px!important;clip-path:inset(0 round 24px)}#__uvd_player_el__ video-skin{background:#fff8fc!important}#__uvd_player_el__.uvd-player-loading,#__uvd_player_el__.uvd-player-loading video-skin,#__uvd_player_el__.uvd-player-loading video{border-radius:24px!important;overflow:hidden!important}
#__uvd_video_wrapper__:fullscreen #__uvd_player_el__,#__uvd_video_wrapper__:fullscreen #__uvd_player_el__ video-skin,#__uvd_video_wrapper__:fullscreen #__uvd_player_el__ video{border-radius:0!important}#__uvd_video_wrapper__:fullscreen #__uvd_player_el__{clip-path:none!important}
...
/* ===== PLAYER CLEANUP – PHASE 3 =====
   Preserve the rounded player skin and shadow, remove conflicting old layers. */
.uvd-player-clean{padding:16px!important;background:radial-gradient(circle at 50% 18%,rgba(255,231,244,.95),rgba(244,233,255,.96) 52%,rgba(239,225,247,.98))!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}.uvd-player-clean .uvd-player-sheet{width:min(100%,560px)!important;height:88dvh!important;max-height:88dvh!important;margin:auto!important;border:1px solid rgba(255,159,180,.34)!important;border-radius:32px!important;background:linear-gradient(160deg,#fff9fc,#f5edff)!important;box-shadow:0 24px 60px rgba(65,32,70,.34),0 0 0 5px rgba(255,255,255,.2) inset!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}.uvd-player-clean .uvd-settings-header{min-height:72px!important;padding:12px 14px!important;background:linear-gradient(135deg,#fff1f7,#ffe8f2)!important;border-bottom:1px solid rgba(255,159,180,.2)!important;box-shadow:none!important}.uvd-player-clean .uvd-player-video-area{padding:8px!important;background:linear-gradient(155deg,#fff2f7,#f8edff)!important}.uvd-player-clean #__uvd_video_wrapper__{border:1px solid rgba(255,159,180,.28)!important;border-radius:22px!important;background:#fff8fc!important;box-shadow:0 14px 30px rgba(87,43,87,.24)!important;overflow:hidden!important}.uvd-player-clean #__uvd_player_el__,.uvd-player-clean #__uvd_player_el__ video-skin,.uvd-player-clean #__uvd_player_el__ video{border-radius:22px!important;overflow:hidden!important;background:#fff8fc!important}.uvd-player-clean #__uvd_player_el__{clip-path:inset(0 round 22px)!important}.uvd-player-clean .uvd-player-info-panel{padding:12px 14px!important;background:linear-gradient(155deg,#fffafd,#f4edff)!important;border-top:1px solid rgba(194,150,255,.2)!important;border-radius:0 0 30px 30px!important;box-shadow:none!important}.uvd-player-clean .uvd-player-cute-panel{gap:6px!important}.uvd-player-clean .uvd-player-mascot-holding{filter:drop-shadow(0 4px 8px rgba(247,108,140,.16))}.uvd-player-clean .uvd-player-tmdb-bar{box-shadow:none!important;background:rgba(255,255,255,.72)!important}.uvd-player-clean .uvd-settings-body{background:transparent!important}.uvd-player-clean #__uvd_video_wrapper__:fullscreen,.uvd-player-clean #__uvd_video_wrapper__:fullscreen #__uvd_player_el__,.uvd-player-clean #__uvd_video_wrapper__:fullscreen #__uvd_player_el__ video-skin,.uvd-player-clean #__uvd_video_wrapper__:fullscreen #__uvd_player_el__ video{border-radius:0!important;box-shadow:none!important}
@media (max-width:560px){.uvd-player-clean{padding:10px!important}.uvd-player-clean .uvd-player-sheet{width:100%!important;height:90dvh!important;max-height:90dvh!important;border-radius:28px!important}.uvd-player-clean .uvd-settings-header{min-height:66px!important;padding:10px 12px!important}.uvd-player-clean #__uvd_video_wrapper__{border-radius:18px!important}.uvd-player-clean #__uvd_player_el__,.uvd-player-clean #__uvd_player_el__ video-skin,.uvd-player-clean #__uvd_player_el__ video{border-radius:18px!important}.uvd-player-clean #__uvd_player_el__{clip-path:inset(0 round 18px)!important}.uvd-player-clean .uvd-player-info-panel{border-radius:0 0 26px 26px!important;padding:10px 12px!important}}

/* Phase 3.1 – player menu palette and light rounded backdrop. */
.uvd-player-clean.uvd-open{background:radial-gradient(circle at 50% 18%,rgba(255,231,244,.95),rgba(244,233,255,.96) 52%,rgba(239,225,247,.98))!important}.uvd-player-clean-menu{background:linear-gradient(155deg,#fffafd,#f6ecff)!important;border:1px solid rgba(194,150,255,.34)!important;box-shadow:0 12px 28px rgba(111,67,122,.2),0 0 0 1px rgba(255,255,255,.78) inset!important;color:#7a4f89!important}.uvd-player-clean-menu button{background:transparent!important;color:#8a6ab0!important;border-color:rgba(194,150,255,.16)!important}.uvd-player-clean-menu button:hover{background:rgba(255,159,180,.15)!important;color:#c95073!important}.uvd-player-clean-menu .uvd-quality-menu-title{color:#c95073!important;border-bottom-color:rgba(255,159,180,.22)!important}.uvd-player-clean-menu .uvd-quality-option-active{background:linear-gradient(135deg,rgba(255,159,180,.18),rgba(194,150,255,.16))!important;color:#c95073!important}.uvd-player-clean-menu .uvd-quality-menu-back{color:#8a6ab0!important}.uvd-player-clean-menu::before{background:linear-gradient(135deg,#fffafd,#f6ecff)!important;border-color:rgba(194,150,255,.34)!important}.uvd-player-clean #__uvd_video_wrapper__{background:#fff8fc!important}
