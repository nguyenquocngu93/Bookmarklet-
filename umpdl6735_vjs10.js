/**
 * Universal Media Player & Downloader - V6.7.25 PRO (fix trượt settings, dung lượng HLS, bo góc dọc, bóng nút)
...
function showVideoPlayer(url, type) {
  ...
  function __uvdApplyPlayerLayout() {
    ...
    if (fs) {
      ...
      // Video dọc: không bo góc, video phủ kín khung (absolute+inset ép full, tránh khoảng trắng do aspect-ratio nội bộ của video-player), lề đều 4 phía
      videoWrapper.style.padding = PORTRAIT_INSET;
      playerEl.style.position = 'absolute';
      playerEl.style.inset = '0';
