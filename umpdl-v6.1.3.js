/**
 * Universal Media Player & Downloader - V6.1
 * - Popup block siêu mạnh, trả lại màu nút, bỏ minimize script, chống trùng video
...
// ========== POPUP / NEW-TAB BLOCKER (SIÊU MẠNH) ==========
...
// ========== OVERLAY PLAYER (chống trùng video) ==========
...
// ========== BUILD UI (CSS gọn, không !important tràn lan) ==========
...
// ========== BUILD UI MAIN (KHÔNG có nút minimize script) ==========
function buildUI() {
...
console.log('V6.1 UMP DL - Popup block mạnh, bỏ minimize script, chống trùng video');
toast('V6.1 sẵn sàng!');
