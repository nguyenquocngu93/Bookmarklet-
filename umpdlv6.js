/**
 * Universal Media Player & Downloader - V6.6 PRO
 * - Tối ưu hiệu năng, bảo mật, UX
 * - Thêm Ghim controls, tìm kiếm stream, điều chỉnh tốc độ +/- 
 * - Giữ nguyên UI/design
...
function showVideoPlayer(url, type) {
  ...
  speedLabel.style.cssText = 'background:rgba(255,255,255,0.1);color:#fff;font-size:12px;padding:7px 6px;';
  ...
  speedDecBtn.style.cssText = 'background:rgba(255,255,255,0.1);color:#fff;font-size:12px;padding:7px 8px;';
  ...
  speedIncBtn.style.cssText = 'background:rgba(255,255,255,0.1);color:#fff;font-size:12px;padding:7px 8px;';
  ...
  pinBtn.style.cssText = 'background:rgba(255,255,255,0.1);color:#fff;font-size:12px;';
  pinBtn.textContent = '📌';
  pinBtn.title = 'Ghim thanh điều khiển (không tự ẩn)';
  pinBtn.onclick = function() {
    playerState.pinned = !playerState.pinned;
    pinBtn.style.background = playerState.pinned ? 'rgba(109,140,255,0.4)' : 'rgba(255,255,255,0.1)';
  ...
  screenshotBtn.style.cssText = 'background:rgba(255,255,255,0.1);color:#fff;font-size:12px;';
  ...
  footer.style.cssText = 'padding:8px 16px;background:rgba(0,0,0,0.7);border-top:1px solid rgba(255,255,255,0.1);font-size:12px;color:#aaa;display:flex;justify-content:space-between;flex-shrink:0;transition: opacity 0.3s ease;';
