...
function showVideoPlayer(url, type) {
  ...
  // Lưu trạng thái reduceMotion và tạm bật để tiết kiệm hiệu năng
  ...
  // Sheet – chiếm 92% chiều cao, bo góc trên, nền glass
  ...
  // ----- Body – chiếm toàn bộ không gian còn lại, không padding, không scroll -----
