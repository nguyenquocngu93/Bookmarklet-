...
// Chrome: backdrop-filter trên phần tử position:fixed đôi khi không vẽ lại kịp
// khi chiều cao viewport đổi đột ngột (tap vào thanh địa chỉ rồi back ra) —
// layer kính (nền mờ) và layer nội dung (icon/chữ) bị "lệch pha" một khung hình,
// nhìn như icon tách khỏi nền. Cách xử lý AN TOÀN: không track vị trí liên tục
// (tránh lặp lại bug trôi cũ), chỉ ép trình duyệt vẽ lại panel một lần sau khi
// viewport đã ổn định.
