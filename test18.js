/**
 * Universal Video Downloader V3.3 – Animated Glass Pro
 * - Ripple effect on buttons
 * - Smooth transitions & hover animations
 * - Card entrance animations
 * - Glassmorphism with dynamic shadows
 * - Pro Player with full controls
...
(function() {
    ...
    style.textContent = `
        ...
        @keyframes uvdGlow{0%{box-shadow:0 0 5px var(--accent)}50%{box-shadow:0 0 20px var(--accent),0 0 40px rgba(59,130,246,0.3)}100%{box-shadow:0 0 5px var(--accent)}}
        ...
        .uvd-player-panel { max-width:900px; padding:0; overflow:hidden; animation:uvdScaleIn 0.4s ease; }
        .uvd-player-header {
    ...
    function buildUI() {
        ...
        header.innerHTML = 
            '<div style="display:flex;align-items:center;gap:8px;">' +
                ...
                '<span style="font-weight:700;font-size:16px;">Universal DL <span style="color:var(--accent);">V3.3</span></span>' +
            '</div>' +
    ...
    function renderStreams(container, arr) {
        ...
        // Gán ripple cho button trong card
    ...
    function renderSettings(container) {
        container.innerHTML = 
            ...
            '<div class="uvd-card" style="margin-top:10px;font-size:12px;color:var(--text2);">' +
                'Version 3.3 · nguyenquocngu93<br>' +
    ...
    console.log('Universal DL V3.3 Animated ready – ' + urls.size + ' streams');
    toast('V3.3 Animated Glass Ready');
