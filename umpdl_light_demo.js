...
function __uvdMountVjs10(wrapper, video) {
  ...
  function wrapWithSkin() {
    ...
    try {
      ...
      player.style.cssText = 'max-width:100%;max-height:100%;width:auto;height:auto;display:block;';
      var skin = document.createElement('video-skin');
      skin.style.cssText = 'max-width:100%;max-height:100%;width:auto;height:auto;display:block;';
      ...
      // Container giờ tự co khít theo kích thước thật của video (video dọc hay
      // ngang đều vậy) thay vì bị ép full 100% wrapper — control bar (nằm ở đáy
      // skin) nhờ đó luôn đè đúng lên video thật, không rơi vào vùng letterbox
      // đen ngoài video. Cách này cũng tránh luôn container bị méo tỉ lệ —
      // nguyên nhân nghi ngờ gây vỡ layout v10 với video dọc trước đây.
    } catch (e) {
...
:root{--bg:rgba(245,244,255,0.9);--glass:rgba(255,255,255,0.55);--glass-hi:rgba(255,255,255,0.45);--border:rgba(36,27,69,0.12);--text:#241b45;--text2:#6b6483;--text3:#a099b8;--accent:#6d5cff;--accent2:#b98bff;--danger:#ff5d72;--gold:#e8a333;--success:#22b56e;--card-bg:rgba(255,255,255,0.55);--fs-xs:11px;--fs-sm:12px;--fs-base:13px;--fs-md:14px;--fs-lg:16px;--radius-sm:12px;--radius-md:16px;--radius-lg:26px;--grad-liquid:linear-gradient(135deg,var(--accent),var(--accent2));--glow-px:0px;--glow-op:0;--btn-bg:rgba(36,27,69,0.06);--btn-danger-bg:rgba(255,93,114,0.15);--btn-danger-border:rgba(255,93,114,0.35);--btn-success-bg:rgba(34,181,110,0.15);--btn-success-border:rgba(34,181,110,0.35);--btn-accent-bg:rgba(109,92,255,0.16);--btn-purple-bg:rgba(167,139,250,0.16);--btn-gold-bg:rgba(232,163,51,0.18)}
