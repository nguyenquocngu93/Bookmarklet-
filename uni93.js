/**
 * Universal Video Downloader V3.5 — Inline Accent + Mesh Glass + Reload
 * Features: Inline vertical accent before text, Fixed preview status,
 *           Mesh gradient glass UI, Noise texture, Reload/Rescan button
...
(function() {
            ...
            '<div class="__uvd_header__">' +
                '<div class="__uvd_header_left__">' +
                    '<div class="__uvd_header_text__">' +
                        '<div class="__uvd_title__"><span class="__uvd_accent_inline__"></span>Universal DL <span class="__uvd_version__">V3.5</span></div>' +
    ...
    function getGlobalCSS(t) {
        ...
        '.__uvd_quality_card__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(10px); padding: 14px; margin-bottom: 10px; border-radius: 12px; box-shadow: inset 0 1px 0 rgba(255,255,255,0.05); }' +
        ...
        '.__uvd_cmd_card__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(10px); padding: 14px; margin-bottom: 10px; border-radius: 12px; box-shadow: inset 0 1px 0 rgba(255,255,255,0.05); }' +
        ...
        '.__uvd_settings_section__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(10px); padding: 14px; margin-bottom: 12px; border-radius: 12px; box-shadow: inset 0 1px 0 rgba(255,255,255,0.05); }' +
        ...
        '.__uvd_theme_btn__ { background: ' + t.bg2 + '; border: 2px solid ' + t.glassBorder + '; color: ' + t.text + '; padding: 12px; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11px; backdrop-filter: blur(10px); transition: all 0.2s; }' +
        ...
        /* FIXED STATUS - bottom left corner, always visible when active */
        '.__uvd_preview_status__ {' +
            'position: absolute; bottom: 75px; left: 12px; z-index: 8;' +
        ...
        '.__uvd_preview_status__::before {' +
            ...
            'animation: uvdPulse 1.5s infinite;' +
        '}' +
        ...
        /* Quality bar - AT TOP under header */
        ...
        '.__uvd_history_item__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(8px); padding: 10px 12px; margin-bottom: 6px; border-radius: 10px; box-shadow: inset 0 1px 0 rgba(255,255,255,0.05); }' +
        ...
        '.__uvd_fav_card__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(8px); padding: 14px; margin-bottom: 10px; border-radius: 12px; border-left: 3px solid gold; box-shadow: inset 0 1px 0 rgba(255,255,255,0.05); }' +
    ...
    function renderSettings(container) {
        ...
        html += '<div class="__uvd_settings_section__"><div class="__uvd_settings_title__"><span class="__uvd_accent_inline__"></span>Thông tin</div>' +
            ...
            '<div><span class="__uvd_accent_inline_small__"></span>Version: 3.5 — Mesh Glass + Reload</div>' +
    ...
    buildUI();
    startAutoRefresh();
    console.log('✅ Universal DL V3.5 loaded! Found', urls.size, 'streams initially');
    toast('V3.5 Mesh Glass Ready!', 'success');
})();