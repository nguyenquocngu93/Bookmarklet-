...
function toast(msg, color) {
  ...
  el.textContent = msg;
  el.style.cssText = 'position:fixed;top:20px;left:50%;transform:translateX(-50%);background:' + (color || '#3b82f6') + ';color:var(--text);padding:12px 24px;border-radius:30px;z-index:2147483649;font:600 13px Segoe UI;box-shadow:0 4px 15px rgba(0,0,0,0.4);animation:uvdSlideIn 0.3s ease;';
  __uvdAppendRoot(el);
...
function showSleepMenu() {
  ...
  panel.innerHTML = '<div style="color:var(--text);font-weight:600;margin-bottom:12px;">⏰ Hẹn giờ ngủ</div>';
...
function showSubtitlePanel(video) {
  ...
  panel.innerHTML =
    ...
    '<div style="display:flex;gap:6px;margin-bottom:8px;">' +
      '<input type="text" id="__uvd_sub_query__" placeholder="Tên phim..." value="' + escapeHtml(pageInfo.title) + '" style="flex:1;padding:9px;background:rgba(0,0,0,0.4);color:var(--text);border:1px solid var(--border);border-radius:10px;font-size:12px;">' +
    ...
    '<details style="margin-top:12px;">' +
      ...
      '<input type="text" id="__uvd_sub_apikey__" placeholder="Dán API key cá nhân (subdl.com)" value="' + escapeHtml(data.settings.subdlApiKey || '') + '" style="width:100%;margin-top:8px;padding:9px;background:rgba(0,0,0,0.4);color:var(--text);border:1px solid var(--border);border-radius:10px;font-size:11px;">' +
...
function showGestureHint(text) {
  ...
  if (!el) {
    ...
    el.style.cssText = 'position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);background:rgba(0,0,0,0.7);color:var(--text);padding:10px 18px;border-radius:12px;font-size:14px;font-weight:600;z-index:5;pointer-events:none;';
...
function showVideoPlayer(url, type) {
  ...
  titleInfo.innerHTML = '<div style="font-weight:600;font-size:14px;color:var(--text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">▶ ' + escapeHtml(pageInfo.title) + '</div><div style="font-size:11px;color:#aaa;margin-top:2px;">' + escapeHtml(type) + '</div>';
  ...
  minVideoBtn.style.cssText = 'background:rgba(255,255,255,0.15);color:var(--text);font-size:12px;';
  ...
  closeBtn.style.cssText = 'background:var(--btn-danger-bg);color:var(--text);border:1px solid var(--btn-danger-border);';
  ...
  qualityBtn.style.cssText = 'background:var(--btn-bg);color:var(--text);font-size:12px;';
  ...
  sleepBtn.style.cssText = 'background:var(--btn-bg);color:var(--text);font-size:12px;';
  ...
  boostBtn.style.cssText = 'background:' + (data.settings.volumeBoost ? 'var(--btn-gold-bg)' : 'var(--btn-bg)') + ';color:var(--text);font-size:12px;';
  ...
  autoNextBtn.style.cssText = 'background:' + (data.settings.autoNext ? 'var(--btn-accent-bg)' : 'var(--btn-bg)') + ';color:var(--text);font-size:12px;';
  ...
  pinBtn.style.cssText = 'background:var(--btn-bg);color:var(--text);font-size:12px;';
  pinBtn.textContent = '📌';
  ...
  screenshotBtn.style.cssText = 'background:var(--btn-bg);color:var(--text);font-size:12px;';
  ...
  subtitleBtn.style.cssText = 'background:var(--btn-bg);color:var(--text);font-size:12px;';
  ...
  if (type === 'M3U8' || type === 'MPD') {
    ...
    shareBtn.style.cssText = 'background:var(--btn-purple-bg);color:var(--text);font-size:12px;';
  ...
  function updateTitleDisplay() {
    ...
    if (playerState._displayedResolution !== currentRes) {
      ...
      infoDiv.innerHTML = '<div style="font-weight:600;font-size:14px;color:var(--text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">▶ ' + escapeHtml(pageInfo.title) + '</div><div style="font-size:11px;color:#aaa;margin-top:2px;">' + escapeHtml(sub) + '</div>';
    }
  }
...
function minimizePlayer() {
  ...
  label.style.cssText = 'position:absolute;bottom:4px;left:8px;color:var(--text);font-size:11px;font-weight:600;text-shadow:0 2px 4px rgba(0,0,0,0.8);background:rgba(0,0,0,0.5);padding:2px 8px;border-radius:4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:90%;';
...
function renderPlayerSettings(container) {
  ...
  container.innerHTML =
    '<div class="uvd-card">' +
      ...
      '<select id="__uvd_set_speed__" style="width:100%;padding:10px;background:rgba(0,0,0,0.4);color:var(--text);border:1px solid var(--border);border-radius:10px;margin-bottom:12px;">' +
      ...
      '<select id="__uvd_set_quality__" style="width:100%;padding:10px;background:rgba(0,0,0,0.4);color:var(--text);border:1px solid var(--border);border-radius:10px;">' +
    ...
    '<div class="uvd-card">' +
      ...
      '<input type="number" id="__uvd_doubletap_seconds__" min="1" max="60" step="1" value="' + s.doubleTapSeconds + '" style="width:100%;padding:10px;background:rgba(0,0,0,0.4);color:var(--text);border:1px solid var(--border);border-radius:10px;">' +
    '</div>' +
    ...
    '<div class="uvd-card">' +
      ...
      '<input type="number" id="__uvd_hide_delay__" min="1" max="30" step="1" value="' + s.hideDelay + '" style="width:100%;padding:10px;background:rgba(0,0,0,0.4);color:var(--text);border:1px solid var(--border);border-radius:10px;">' +
    '</div>' +
