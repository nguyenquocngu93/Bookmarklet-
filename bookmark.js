...
/* ===== DIGGING SIZE HARD GUARANTEE ===== */
#__uvd_digging_popup__>.uvd-digging-box{height:90dvh!important;min-height:90dvh!important;max-height:90dvh!important;overflow-y:auto!important;justify-content:flex-start!important}#__uvd_digging_popup__>.uvd-digging-box::-webkit-scrollbar{display:none}@media (max-width:560px){#__uvd_digging_popup__>.uvd-digging-box{height:90dvh!important;min-height:90dvh!important;max-height:90dvh!important}}


/* ===== POPUP SIZE CLASSES: LARGE WORKFLOWS VS SMALL TOOLS ===== */
/* Large: digging, media links, iframe workflow, farewell. */
#__uvd_digging_popup__>.uvd-digging-box{width:min(94vw,680px)!important;height:calc(100dvh - 24px)!important;min-height:calc(100dvh - 24px)!important;max-height:calc(100dvh - 24px)!important;justify-content:space-evenly!important;padding:22px 28px!important;overflow-y:auto!important}#__uvd_digging_popup__ .uvd-dig-art{margin:0 auto!important}#__uvd_digging_popup__ .uvd-dig-title{font-size:31px!important;line-height:1.15!important}#__uvd_digging_popup__ .uvd-dig-sub{font-size:16px!important;line-height:1.5!important;max-width:440px!important}#__uvd_digging_popup__ .uvd-dig-status-row span{font-size:12px!important;padding:7px 12px!important}#__uvd_digging_popup__ .uvd-dig-watch-first-btn,#__uvd_digging_popup__ .uvd-dig-enter-btn{font-size:16px!important;min-height:60px!important}#__uvd_digging_popup__ .uvd-dig-route-hint,#__uvd_digging_popup__ .uvd-dig-help{font-size:12px!important}#__uvd_media_links_prompt__>.uvd-media-choice-popup,#__uvd_iframe_workflow_prompt__>.uvd-glass-panel{width:min(94vw,680px)!important;height:calc(100dvh - 24px)!important;max-height:calc(100dvh - 24px)!important}#__uvd_farewell_popup__>.uvd-farewell-box{width:min(94vw,680px)!important;height:calc(100dvh - 24px)!important;max-height:calc(100dvh - 24px)!important;justify-content:space-evenly!important}
/* Small: pre-open card and preview inspector. */
#__uvd_play_intro__>div{width:min(92vw,460px)!important;height:auto!important;min-height:0!important;max-height:78dvh!important;justify-content:center!important}#__uvd_media_preview__>.uvd-media-preview-panel{width:min(94vw,680px)!important;height:auto!important;min-height:0!important;max-height:82dvh!important;justify-content:flex-start!important}@media (max-width:560px){#__uvd_digging_popup__>.uvd-digging-box,#__uvd_media_links_prompt__>.uvd-media-choice-popup,#__uvd_iframe_workflow_prompt__>.uvd-glass-panel,#__uvd_farewell_popup__>.uvd-farewell-box{width:calc(100vw - 20px)!important;height:calc(100dvh - 20px)!important;min-height:calc(100dvh - 20px)!important;max-height:calc(100dvh - 20px)!important;padding:18px!important}#__uvd_digging_popup__ .uvd-dig-title{font-size:27px!important}#__uvd_digging_popup__ .uvd-dig-sub{font-size:14px!important}}
