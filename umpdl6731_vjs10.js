...
function showVideoPlayer(url, type) {
  ...
  titleSpan.style.cssText = 'flex:1; text-align:center; font-weight:600; font-size:14px; color:var(--text);';
  ...
  // Không đổ bóng vào wrapper, chỉ giữ background trong suốt
  ...
  // Bóng được đổ trực tiếp lên video, có bo góc
  video.style.cssText = 'max-width:100%; max-height:100%; width:100%; height:100%; display:block; object-fit:contain; border-radius:12px; box-shadow: 4px 4px 20px rgba(0,0,0,0.45), -2px -2px 8px rgba(255,255,255,0.05);';
  ...
  content.style.cssText = 'max-height:60vh;overflow-y:auto;display:flex;flex-direction:column;gap:8px;'; // dùng gap thay margin
  
  options.forEach(function(opt) {
    var btn = document.createElement('button');
    btn.className = 'uvd-btn uvd-btn-sm';
    // Style mới: không bóng, nền nhạt, bo góc, khoảng cách đều
    btn.style.cssText = 'width:100%; padding:12px 10px; background:rgba(155,61,255,0.08); border:1px solid var(--border); border-radius:12px; color:var(--text); font-weight:600; font-size:14px; cursor:pointer; transition:background 0.15s ease; box-shadow:none; text-align:center;';
  ...
  // Nút Đóng cũng được chỉnh tương tự
  var closeBtn = document.createElement('button');
  closeBtn.textContent = 'Đóng';
  closeBtn.className = 'uvd-btn uvd-btn-sm';
  closeBtn.style.cssText = 'width:100%; margin-top:12px; padding:12px 10px; background:rgba(255,93,114,0.12); border:1px solid var(--border); border-radius:12px; color:var(--text); font-weight:600; font-size:14px; cursor:pointer; transition:background 0.15s ease; box-shadow:none; text-align:center;';
  ...
  // ─── KHỞI TẠO PHÁT VIDEO (giữ nguyên) ───
