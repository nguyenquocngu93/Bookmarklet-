/**
 * Universal Media Player & Downloader - V5.7
...
// Khi mô phỏng click vào nút Play, một số site gắn quảng cáo popunder/popup
// ngay trên chính nút đó -> nhảy tab mới hoặc mở popup. Hàm này tạm thời
// chặn window.open() và click vào link target="_blank" trong lúc mô phỏng.
...
console.log('V5.7 UMP DL - Auto-pause Background Video Ready');
toast('V5.7 sẵn sàng!');
