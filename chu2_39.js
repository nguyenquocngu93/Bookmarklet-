...
function showVideoPlayer(url, type) {
  ...
  function __uvdApplyPlayerLayout() {
    ...
    playerEl.style.borderRadius = '0'; // hoặc 16px tuỳ gu
    video.style.borderRadius = playerEl.style.borderRadius;
    playerEl.style.boxShadow = 'none';
    video.style.boxShadow = FLOAT_SHADOW;
    ...
    // ✅ Bo góc cho cả container và video
    playerEl.style.borderRadius = '16px';
    video.style.borderRadius = '16px';

    // ✅ Chuyển bóng đổ sang video
    playerEl.style.boxShadow = 'none'; // tắt bóng trên container
    video.style.boxShadow = FLOAT_SHADOW;

    video.style.objectFit = 'contain';

    // ✅ Cắt góc thừa và đồng nền
    playerEl.style.overflow = 'hidden';
    videoWrapper.style.background = '#000';
}
  }
