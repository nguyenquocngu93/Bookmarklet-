...
function buildUI() {
  ...
  header.innerHTML =
    ...
    '<div style="display:flex;gap:6px;">' +
      '<button class="uvd-btn-icon uvd-ripple-btn" id="__uvd_simplay__" title="Giả lập Play (cho trang lazy-load)" style="background:rgba(139,92,246,0.25);"><span style="font-size:16px;">▶</span></button>' +
