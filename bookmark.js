...
.uvd-dig-kicker{font-size:11px;font-weight:850;letter-spacing:.13em;text-transform:uppercase;color:#c95073;position:relative;z-index:2;margin-top:4px}.uvd-dig-title{margin-top:12px;font-size:28px;font-weight:900;color:#d84972;line-height:1.2;position:relative;z-index:2}.uvd-dig-sub{min-height:23px;margin:10px auto 0;color:#956077;font-size:14px;font-weight:650;line-height:1.5;position:relative;z-index:2}.uvd-dig-enter-btn{display:block;width:100%;max-height:0;margin-top:0;padding:0;overflow:hidden;opacity:0;border:0;border-radius:16px;background:linear-gradient(135deg,#ff91ae,#ef6689);color:#fff;font-size:16px;font-weight:850;box-shadow:0 8px 18px rgba(231,83,127,.3);transition:max-height .28s ease,margin .28s ease,padding .28s ease,opacity .22s ease,transform .18s ease}.uvd-dig-enter-btn:active{transform:scale(.97)}
