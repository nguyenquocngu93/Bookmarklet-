/**
 * Universal Media Player & Downloader - V5.9 (Hoàn chỉnh)
...
// ========== OVERLAY PLAYER WITH TOOLBAR (FIXES) ==========
function showVideoPlayer(url, type) {
  ...
  header.style.cssText = 'padding:10px 16px;background:rgba(0,0,0,0.5);backdrop-filter:blur(12px) saturate(150%);-webkit-backdrop-filter:blur(12px) saturate(150%);display:flex;flex-direction:column;flex-shrink:0;border-bottom:1px solid rgba(255,255,255,0.1);';
...
console.log('V5.9 UMP DL - ABR fix, Header blur, Adblock ready');
toast('V5.9 sẵn sàng — ABR auto resolution, header kính mờ, lọc quảng cáo!');
