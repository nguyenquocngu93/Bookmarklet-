/**
 * Universal Video Downloader V3.3 — Glass UI Restored + Photo Preview
 * Fixes: Overlap layout, Glass blur UI, Photo thumbnails
...
(function() {
    ...
    // ========== GLASS UI THEMES (Beautiful + Balanced) ==========
    var themes = {
        'glass-dark': {
            name: '🌙 Glass Dark',
            bg: 'rgba(12, 12, 18, 0.82)',
            bg2: 'rgba(22, 22, 32, 0.75)',
            bg3: 'rgba(32, 32, 48, 0.6)',
            ...
            text3: '#808098',
            primary: '#7C6CFF',
            primaryGlow: 'rgba(124, 108, 255, 0.35)',
            accent: '#00E5FF',
        ...
        'glass-light': {
            ...
            text3: '#8a8aa0',
            primary: '#5B4FCF',
            primaryGlow: 'rgba(91, 79, 207, 0.25)',
            accent: '#0099CC',
            accentGlow: 'rgba(0, 153, 204, 0.25)',
            danger: '#E63946',
            success: '#2A9D4A',
            warning: '#E67E00'
        },
        'glass-purple': {
            name: '💜 Glass Purple',
            bg: 'rgba(18, 5, 35, 0.82)',
            bg2: 'rgba(32, 10, 55, 0.75)',
            bg3: 'rgba(48, 15, 75, 0.6)',
            glass: 'rgba(187, 134, 252, 0.08)',
        ...
        'glass-matrix': {
            ...
            text3: '#007722',
            primary: '#00ff41',
            primaryGlow: 'rgba(0, 255, 65, 0.35)',
            accent: '#00ffcc',
        ...
        'glass-cyber': {
            name: '🌸 Glass Cyber',
            bg: 'rgba(15, 5, 25, 0.82)',
            bg2: 'rgba(25, 10, 40, 0.75)',
            bg3: 'rgba(40, 15, 60, 0.6)',
            glass: 'rgba(255, 0, 128, 0.08)',
            glassBorder: 'rgba(255, 0, 128, 0.2)',
            text: '#ffffff',
            text2: '#ff99cc',
            text3: '#994488',
            primary: '#FF2D95',
            primaryGlow: 'rgba(255, 45, 149, 0.35)',
            accent: '#00F0FF',
    ...
    function toast(msg, type) {
        ...
        el.innerText = msg;
        el.style.cssText = 'position:fixed;top:20px;left:50%;transform:translateX(-50%);background:' + color + ';color:#fff;padding:10px 20px;border-radius:12px;z-index:2147483649;font:bold 12px -apple-system,Arial,sans-serif;box-shadow:0 4px 20px ' + color + '60, 0 0 30px ' + color + '30;opacity:0;transition:opacity 0.2s;pointer-events:none;';
            ...
            '<div class="__uvd_header__">' +
                '<div class="__uvd_header_left__">' +
                    ...
                    '<div class="__uvd_header_text__">' +
                        '<div class="__uvd_title__">Universal DL <span class="__uvd_version__">V3.3</span></div>' +
    ...
    function getGlobalCSS(t) {
        ...
        '@keyframes uvdGlow { 0%, 100% { box-shadow: 0 0 8px ' + t.primaryGlow + '; } 50% { box-shadow: 0 0 20px ' + t.primaryGlow + ', 0 0 30px ' + t.primaryGlow + '; } }' +
        ...
        '.__uvd_panel__ {' +
            ...
            'overflow: hidden;' +
            'box-shadow: 0 0 40px rgba(0,0,0,0.5), inset 0 1px 0 ' + t.glassBorder + ';' +
        ...
        '.__uvd_panel__ ::-webkit-scrollbar { width: 5px; }' +
        '.__uvd_panel__ ::-webkit-scrollbar-track { background: transparent; }' +
        '.__uvd_panel__ ::-webkit-scrollbar-thumb { background: ' + t.primary + '60; border-radius: 3px; }' +
        ...
        '.__uvd_logo__ { font-size: 26px; filter: drop-shadow(0 0 6px ' + t.primaryGlow + '); flex-shrink: 0; }' +
        ...
        '.__uvd_version__ { font-size: 9px; background: linear-gradient(135deg, ' + t.primary + ', ' + t.accent + '); color: #fff; padding: 2px 6px; border-radius: 4px; vertical-align: middle; box-shadow: 0 0 10px ' + t.primaryGlow + '; }' +
        ...
        '.__uvd_live_dot__ { width: 6px; height: 6px; background: ' + t.success + '; border-radius: 50%; display: inline-block; animation: uvdPulse 1.5s infinite; flex-shrink: 0; box-shadow: 0 0 6px ' + t.success + '; }' +
        ...
        '}' +
        '.__uvd_btn_icon__:hover { background: ' + t.primary + '40; border-color: ' + t.primary + '; }' +
        ...
        '}' +
        '.__uvd_search_icon__ { font-size: 13px; opacity: 0.7; }' +
        ...
        '.__uvd_tabs__ {' +
            'display: flex; background: ' + t.bg2 + '; padding: 6px; gap: 4px;' +
        ...
        '.__uvd_tab__.active {' +
            'background: linear-gradient(135deg, ' + t.primary + '35, ' + t.accent + '20);' +
            'color: ' + t.text + ';' +
            'border-color: ' + t.primary + '80;' +
        ...
        '}' +
        '.__uvd_tab__.active .__uvd_badge__ { background: ' + t.primary + '60; border-color: ' + t.primary + '; }' +
        ...
        '.__uvd_info_label__ { opacity: 0.7; }' +
        ...
        '.__uvd_content__ { flex: 1; overflow-y: auto; padding: 12px 14px; -webkit-overflow-scrolling: touch; }' +
        ...
        '}' +
        '.__uvd_card__:hover { border-color: ' + t.primary + '60; box-shadow: 0 4px 20px ' + t.primaryGlow + '; }' +
        ...
        '.__uvd_fav_btn__ { background: transparent; border: 0; font-size: 18px; cursor: pointer; padding: 2px 4px; -webkit-tap-highlight-color: transparent; transition: transform 0.2s; }' +
        '.__uvd_fav_btn__:active { transform: scale(1.2); }' +
        '.__uvd_url_box__ {' +
        ...
        '.__uvd_act_btn__ {' +
            'border: 0; padding: 10px 6px; border-radius: 9px; font-size: 11px; font-weight: 600;' +
        ...
        '.__uvd_footer__ {' +
            'background: ' + t.bg2 + '; backdrop-filter: blur(12px); padding: 10px 12px;' +
            'border-top: 1px solid ' + t.glassBorder + '; display: flex; gap: 6px; flex-wrap: wrap; flex-shrink: 0;' +
        '}' +
        '.__uvd_footer_btn__ {' +
            'background: ' + t.glass + '; border: 1px solid ' + t.glassBorder + ';' +
            'color: ' + t.text + '; padding: 8px 10px; border-radius: 9px; font-size: 11px; font-weight: 600;' +
            'flex: 1; min-width: 60px; cursor: pointer; backdrop-filter: blur(8px);' +
            'transition: all 0.2s ease;' +
            '-webkit-tap-highlight-color: transparent;' +
        '}' +
        ...
        '.__uvd_empty_icon__ { font-size: 44px; margin-bottom: 12px; opacity: 0.5; filter: drop-shadow(0 0 10px ' + t.primaryGlow + '); }' +
        ...
        '.__uvd_photo_thumb__ {' +
            ...
            'transition: all 0.2s ease;' +
        '}' +
        '.__uvd_photo_thumb__:active { transform: scale(0.98); }' +
        ...
        '.__uvd_photo_thumb_wrap__ .__uvd_photo_overlay__ {' +
            'position: absolute; inset: 0; background: rgba(0,0,0,0.3);' +
            'display: flex; align-items: center; justify-content: center;' +
            'opacity: 0; transition: opacity 0.2s;' +
        '}' +
        '.__uvd_photo_thumb_wrap__:active .__uvd_photo_overlay__ { opacity: 1; }' +
        '.__uvd_photo_thumb_wrap__ .__uvd_photo_overlay__ span { color: #fff; font-size: 28px; }' +
        ...
        '}' +
        '.__uvd_overlay_box__ {' +
            'background: ' + t.bg + '; backdrop-filter: blur(20px) saturate(150%);' +
            'border: 1px solid ' + t.glassBorder + ';' +
            'border-radius: 16px; padding: 16px; width: 100%; max-width: 600px; margin: auto;' +
            'box-shadow: 0 20px 60px rgba(0,0,0,0.5), inset 0 1px 0 ' + t.glassBorder + ';' +
        '}' +
        '.__uvd_overlay_title__ { color: ' + t.primary + '; font-size: 17px; font-weight: 700; margin-bottom: 14px; display: flex; align-items: center; gap: 8px; text-shadow: 0 0 20px ' + t.primaryGlow + '; }' +
        
        '.__uvd_quality_card__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(6px); padding: 14px; margin-bottom: 10px; border-radius: 12px; transition: all 0.2s; }' +
        '.__uvd_quality_card__:hover { border-color: ' + t.primary + '80; }' +
        '.__uvd_quality_header__ { display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px; }' +
        '.__uvd_quality_label__ { color: ' + t.primary + '; font-size: 16px; font-weight: 700; text-shadow: 0 0 10px ' + t.primaryGlow + '; }' +
        '.__uvd_quality_info__ { color: ' + t.text3 + '; font-size: 10px; margin-bottom: 10px; }' +
        
        '.__uvd_cmd_card__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(6px); padding: 14px; margin-bottom: 10px; border-radius: 12px; }' +
        ...
        '.__uvd_btn_primary__ { background: linear-gradient(135deg, ' + t.primary + ', ' + t.accent + '); color: #fff; border: 0; padding: 11px 18px; border-radius: 10px; font-weight: 700; font-size: 12px; cursor: pointer; flex: 1; box-shadow: 0 4px 15px ' + t.primaryGlow + '; -webkit-tap-highlight-color: transparent; transition: all 0.2s; }' +
        ...
        '.__uvd_btn_ghost__ { background: ' + t.glass + '; border: 1px solid ' + t.glassBorder + '; color: ' + t.text + '; padding: 11px 18px; border-radius: 10px; font-weight: 600; font-size: 12px; cursor: pointer; flex: 1; backdrop-filter: blur(8px); }' +
        
        '.__uvd_settings_section__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(6px); padding: 14px; margin-bottom: 12px; border-radius: 12px; }' +
        ...
        '.__uvd_theme_btn__ { background: ' + t.bg2 + '; border: 2px solid ' + t.glassBorder + '; color: ' + t.text + '; padding: 12px; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11px; backdrop-filter: blur(8px); transition: all 0.2s; }' +
        ...
        /* ========== PREVIEW PLAYER - FULL LANDSCAPE + FIX OVERLAP ========== */
        ...
        '.__uvd_preview_status__ {' +
            ...
            'transition: opacity 0.3s ease;' +
            'z-index: 5; text-shadow: 0 1px 4px rgba(0,0,0,0.5);' +
        '}' +
        '.__uvd_preview_status__.visible { opacity: 1; }' +
        
        /* Quality bar - ABOVE controls, no overlap */
        '.__uvd_preview_quality_bar__ {' +
            'position: absolute; bottom: 80px; left: 12px; right: 12px; z-index: 10;' +
        ...
        '.__uvd_preview_quality_label__ { color: #fff; font-size: 12px; font-weight: 600; margin-bottom: 10px; }' +
        '.__uvd_preview_quality_list__ { display: flex; gap: 8px; flex-wrap: wrap; }' +
        
        /* Controls - at bottom, clear of quality bar */
        ...
        '.__uvd_preview_btn__ {' +
            ...
            'transition: all 0.2s; -webkit-tap-highlight-color: transparent;' +
        '}' +
        '.__uvd_preview_btn__:active { background: rgba(255,255,255,0.3); transform: scale(0.95); }' +
        '.__uvd_preview_btn__.active { background: ' + t.primary + '; border-color: ' + t.primary + '; box-shadow: 0 0 15px ' + t.primaryGlow + '; }' +
        ...
        '@media (orientation: landscape) {' +
            ...
            '.__uvd_preview_quality_bar__ { bottom: 70px; }' +
        '}' +
        ...
        '.__uvd_history_item__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(6px); padding: 10px 12px; margin-bottom: 6px; border-radius: 10px; }' +
        ...
        '.__uvd_fav_card__ { background: ' + t.bg3 + '; border: 1px solid ' + t.glassBorder + '; backdrop-filter: blur(6px); padding: 14px; margin-bottom: 10px; border-radius: 12px; border-left: 4px solid gold; }' +
            ...
            if (category === 'photo') {
                photoHtml = 
                    '<div class="__uvd_photo_thumb_wrap__" data-fullscreen="' + encodeURIComponent(url) + '">' +
                        ...
                        '<div class="__uvd_photo_overlay__"><span>🔍 Xem lớn</span></div>' +
                    '</div>';
            }
    ...
    function showPreview(url, type) {
        ...
        document.getElementById('__pv_cmd__').addEventListener('click', function(e) { e.stopPropagation(); cleanup(); showCommandPicker(url, type || 'M3U8'); });
        ...
        video.addEventListener('error', function() { showStatus('❌ Lỗi phát video', 3000); });
        ...
        function loadHls() {
            if (window.Hls) { initHls(); }
                ...
                hlsScript.onerror = function() { showStatus('❌ Không load được HLS.js', 3000); video.src = url; };
    ...
    function showEditor(text, title) {
        ...
        document.getElementById('__uvd_ed_ok__').addEventListener('click', function() { copy(textarea.value); overlay.remove(); toast('✓ Đã copy!', 'success'); });
        document.getElementById('__uvd_ed_share__').addEventListener('click', function() { var val = textarea.value; overlay.remove(); shareUrl(val); });
    ...
    function renderFavorites(container) {
        ...
        container.addEventListener('click', function(e) {
            ...
            if (btn) {
                var action = btn.dataset.action;
                if (action === 'del') { data.favorites.splice(parseInt(btn.dataset.idx), 1); storage.set(data); renderFavorites(container); toast('🗑️ Đã xóa', 'info'); }
                else {
    ...
    function renderHistory(container) {
        ...
        clearBtn.addEventListener('click', function() {
            if (confirm('Xóa toàn bộ history?')) { data.history = []; storage.set(data); renderHistory(container); toast('🗑️ Đã xóa history', 'info'); }
        });
    ...
    function renderSettings(container) {
        ...
        if (!profiles.length) { html += '<div style="color:' + t.text3 + ';font-size:10px;">Chưa có profile. Bấm vào Referer để lưu.</div>'; }
            ...
            profiles.forEach(function(p) {
                html += '<div class="__uvd_profile_card__"><div class="__uvd_profile_host__">' + p + '</div>' +
                    ...
                    '<button class="__uvd_btn_danger__ __uvd_delprofile__" data-host="' + p + '" style="padding:4px 10px;font-size:10px;margin-top:6px;">🗑️ Xóa</button></div>';
            });
        }
        html += '</div>';
        ...
        html += '<div class="__uvd_settings_section__"><div class="__uvd_settings_title__">ℹ️ Thông tin</div>' +
            ...
            '<div>📦 Version: 3.3 — Glass UI Restored</div>' +
        ...
        container.addEventListener('click', function(e) {
            ...
            if (delBtn) { delete data.siteProfiles[delBtn.dataset.host]; storage.set(data); renderSettings(container); toast('🗑️ Đã xóa profile', 'info'); }
        });
    ...
    buildUI();
    startAutoRefresh();
    console.log('✅ Universal DL V3.3 loaded! Found', urls.size, 'streams initially');
    toast('✅ V3.3 Glass UI Ready!', 'success');
})();