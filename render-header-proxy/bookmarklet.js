...
.uvd-digging-overlay.uvd-dig-found .uvd-dig-title{color:#b85dc8}.uvd-digging-overlay.uvd-dig-found .uvd-dig-enter-btn{max-height:54px;margin-top:16px;padding:14px 16px;opacity:1}.uvd-digging-overlay.uvd-dig-found .uvd-dig-dirt{animation-play-state:paused;opacity:.38}.uvd-dig-ui-btn{width:100%;margin-top:10px;padding:10px 14px;border:1px solid rgba(179,133,242,.46);border-radius:15px;background:rgba(255,255,255,.58);color:#8a6ab0;font-size:13px;font-weight:850;box-shadow:0 4px 11px rgba(150,90,220,.1);cursor:pointer}.uvd-dig-ui-btn:active{transform:scale(.98);background:rgba(243,231,255,.85)}.uvd-dig-route-hint{max-height:0;margin:0;overflow:hidden;opacity:0;color:#8a6ab0;font-size:11.5px;font-weight:700;line-height:1.4;transition:max-height .28s ease,margin .28s ease,opacity .22s ease}.uvd-digging-overlay.uvd-dig-found .uvd-dig-route-hint{max-height:38px;margin-top:8px;opacity:1}
...
.uvd-tutorial-mascot-stage{position:relative;width:228px;height:206px;display:flex;flex-direction:column;align-items:center;justify-content:center;margin:4px auto 8px;background:transparent!important;border:none!important;box-shadow:none!important;overflow:visible}.uvd-tutorial-mascot-art{width:176px;height:184px;line-height:0;filter:drop-shadow(0 12px 16px rgba(247,108,140,.22));animation:uvdMascotHop 1.9s ease-in-out infinite}.uvd-tutorial-mascot-art svg{width:100%;height:100%;display:block;animation:uvdMascotWiggle 1.45s ease-in-out infinite}.uvd-tutorial-mascot-label{position:static;transform:none;margin-top:-12px;padding:0;background:transparent!important;border:none!important;box-shadow:none!important;color:#8a6ab0;font-size:10px;font-weight:900;white-space:nowrap;letter-spacing:.03em}
`;
