 ...
 * - Sửa minimize Script panel: cuộn phần dưới lên, chỉ chừa lại header (thay vì nút nổi)
 * - Header vẫn thao tác được (Play/Làm mới/Đóng) khi đang thu nhỏ
 * - Dọn code trùng lặp, bỏ nút nổi __uvd_min_float__ không còn dùng
...
console.log('V' + VERSION + ' UMP DL - Thu nhỏ dạng cuộn lên header, tối ưu code');
toast('V' + VERSION + ' sẵn sàng!');
