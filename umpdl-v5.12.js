/**
 * Universal Media Player & Downloader - V5.9 (ABR fix, Header blur, Adblock)
 * Phần 1/2
 */
(function() {
'use strict';
...
function showVideoPlayer(url, type) {
  ...
  titleInfo.innerHTML = 
    ...
    '<div style="font-size:11px;color:#aaa;margin-top:2px;">' + type + '</div>';
  ...
  video.addEventListener('timeupdate', function() {
    ...
    updateTitleDisplay(); // cập nhật resolution liên tục
  });
