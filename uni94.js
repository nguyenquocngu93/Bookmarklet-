/**
 * Universal Video Downloader V3.6 — Full Fix
 * Fixes: Accent on buttons, Quality lag/empty, Status hidden,
 *        Command picker breaks video, Fullscreen rotation
...
(function() {
            ...
            '<div class="__uvd_header__">' +
                '<div class="__uvd_header_left__">' +
                    '<div class="__uvd_header_text__">' +
                        '<div class="__uvd_title__"><span class="__uvd_accent_inline__"></span>Universal DL <span class="__uvd_version__">V3.6</span></div>' +
    ...
    function showPreview(url, type) {
        ...
        // FIX: Fullscreen với orientation lock
    ...
    function enterFullscreen(element) {
        // Thử lock orientation landscape trước
        if (screen.orientation && screen.orientation.lock) {
            screen.orientation.lock('landscape').catch(function() {
                // Ignore error, continue with fullscreen
            });
        }
    ...
    function renderSettings(container) {
        ...
        html += '<div class="__uvd_settings_section__"><div class="__uvd_settings_title__"><span class="__uvd_accent_inline__"></span>Thông tin</div>' +
            ...
            '<div><span class="__uvd_accent_inline_small__"></span>Version: 3.6 — Full Fix</div>' +
    ...
    buildUI();
    startAutoRefresh();
    console.log('✅ Universal DL V3.6 loaded! Found', urls.size, 'streams initially');
    toast('V3.6 Full Fix Ready!', 'success');
})();