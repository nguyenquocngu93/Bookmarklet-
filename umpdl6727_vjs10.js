/**
 * Universal Media Player & Downloader - V6.7.21 PRO (tối ưu hiệu năng + giao diện hồng tím sáng)
 * - Header player chỉ hiển thị "Player"
 * - Card thông tin phim ở dưới: tên, định dạng, độ phân giải, bitrate, dung lượng
 * - Màu hồng tím sáng (#ff6bb5, #ffb3e6)
 * - Tích hợp vượt quảng cáo đếm ngược (⏳)
 * - Tối ưu observer, scan, debounce buildUI
...
.uvd-glass-panel::before{content:'';position:absolute;top:0;left:8%;right:8%;height:1px;z-index:2;background:linear-gradient(90deg,transparent,rgba(255,107,181,0.6),rgba(255,179,230,0.6),transparent);opacity:0.7}
...
.uvd-liquid-bg{position:absolute;inset:-20%;z-index:0;pointer-events:none;background:radial-gradient(closest-side,rgba(255,107,181,0.14),transparent 70%) 20% 25%/60% 60% no-repeat;filter:blur(28px);animation:uvdLiquidDrift 16s ease-in-out infinite}
...
.uvd-settings-title{font-weight:700;font-size:16px;color:#ff6bb5;text-shadow:0 0 12px rgba(255,107,181,0.5)}
...
.uvd-tab-indicator{position:absolute;top:4px;bottom:4px;left:0;width:0;border-radius:999px;background:linear-gradient(135deg,#ff6bb5,#ffb3e6);z-index:0;box-shadow:0 3px 12px rgba(255,107,181,0.45);transition:transform .4s cubic-bezier(.4,0,.2,1),width .4s cubic-bezier(.4,0,.2,1)}
...
.uvd-scope{color:var(--text);font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display','Segoe UI',Roboto,sans-serif;--bg:rgba(6,3,8,0.97);--glass:rgba(20,10,22,0.86);--glass-hi:rgba(255,179,230,0.05);--border:rgba(255,179,230,0.12);--text:#f3f5ff;--text2:#bfb0d4;--text3:#7a6a8a;--accent:#ff6bb5;--accent2:#ffb3e6;--danger:#ff5d72;--gold:#ffb84d;--success:#34d399;--card-bg:rgba(255,255,255,0.03);--fs-xs:11px;--fs-sm:12px;--fs-base:13px;--fs-md:14px;--fs-lg:16px;--radius-sm:14px;--radius-md:20px;--radius-lg:32px;--grad-liquid:linear-gradient(135deg,#ff6bb5,#ffb3e6);--glow-px:0px;--glow-op:0;--btn-bg:rgba(255,255,255,0.1);--btn-danger-bg:rgba(255,93,114,0.22);--btn-danger-border:rgba(255,93,114,0.4);--btn-success-bg:rgba(52,211,153,0.2);--btn-success-border:rgba(52,211,153,0.4);--btn-accent-bg:rgba(255,107,181,0.28);--btn-purple-bg:rgba(214,74,199,0.26);--btn-gold-bg:rgba(255,184,77,0.26)}
.uvd-fx-on .uvd-btn{transition:box-shadow .25s ease,transform .15s ease}
.uvd-fx-on .uvd-btn:active{transform:scale(.95)}
.uvd-fx-on.uvd-glass-panel,.uvd-fx-on #__uvd_player_header__{box-shadow:0 0 var(--glow-px) rgba(255,107,181,var(--glow-op)),0 8px 30px rgba(0,0,0,0.5)}
...
.uvd-card:hover{transform:translateY(-5px) scale(1.01);box-shadow:0 18px 40px rgba(0,0,0,0.8),0 0 0 1px rgba(255,107,181,0.4) inset}
.uvd-type-badge{display:inline-block;padding:4px 12px;border-radius:var(--radius-sm);font-size:var(--fs-xs);font-weight:700;background:linear-gradient(135deg,rgba(255,107,181,0.22),rgba(255,179,230,0.18));color:#ff6bb5;border:1px solid rgba(255,107,181,0.28);letter-spacing:.03em}
...
.uvd-profile-card{display:flex;align-items:center;gap:14px;background:linear-gradient(135deg,rgba(255,107,181,0.14),rgba(255,179,230,0.08));border:1px solid rgba(255,107,181,0.25);border-radius:var(--radius-lg);padding:16px;margin-bottom:10px;animation:uvdCardEnter .4s ease both}
.uvd-profile-avatar{flex-shrink:0;width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,#ff6bb5,#ffb3e6);color:#fff;font-weight:700;font-size:18px;display:flex;align-items:center;justify-content:center;box-shadow:0 6px 18px rgba(255,107,181,0.4),0 0 0 3px rgba(255,255,255,0.08)}
...
.uvd-stat-num{font-size:18px;font-weight:700;color:#ff6bb5}
...
.uvd-section-num{width:20px;height:20px;border-radius:50%;background:linear-gradient(135deg,#ff6bb5,#ffb3e6);color:#fff;font-size:11px;display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 2px 8px rgba(255,107,181,0.4)}
.uvd-timeline-card{border-left:2px solid rgba(255,107,181,0.3)}
.uvd-inline-code{display:inline-block;background:rgba(0,0,0,0.35);padding:3px 9px;border-radius:6px;color:#ffb3e6;font-family:'SFMono-Regular',Consolas,monospace;font-size:11px;border:1px solid rgba(255,255,255,0.06);margin:2px 0}
...
.uvd-step-num{flex-shrink:0;width:24px;height:24px;border-radius:50%;background:linear-gradient(135deg,#ff6bb5,#ffb3e6);color:#fff;font-size:12px;font-weight:700;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 8px rgba(255,107,181,0.4)}
.uvd-step-text{font-size:13px;color:var(--text2);line-height:1.65;padding-top:2px}
.uvd-step-text strong{color:var(--text)}
.uvd-callout{display:flex;gap:10px;align-items:flex-start;background:rgba(255,107,181,0.1);border:1px solid rgba(255,107,181,0.25);border-left:3px solid #ff6bb5;border-radius:10px;padding:10px 12px;margin-top:10px;font-size:12px;color:var(--text2);line-height:1.6}
.uvd-callout-icon{flex-shrink:0;font-size:15px}
.uvd-callout.uvd-callout-warn{background:rgba(255,184,77,0.1);border-color:rgba(255,184,77,0.3);border-left-color:#ffb84d}
.uvd-code-block{position:relative;background:rgba(0,0,0,0.5);border:1px solid var(--border);border-radius:10px;margin:8px 0}
.uvd-code-block textarea{width:100%;background:transparent;border:none;color:#ffb3e6;padding:10px 40px 10px 12px;font-size:10px;font-family:'SFMono-Regular',Consolas,monospace;resize:none}
...
function buildUI() {
  ...
  header.innerHTML = 
    '<div style="display:flex;align-items:center;gap:8px;">' +
      '<span style="width:10px;height:10px;background:linear-gradient(135deg,#ff6bb5,#ffb3e6);border-radius:50%;animation:uvdPulse 2s infinite;box-shadow:0 0 8px rgba(255,107,181,0.6);"></span>' +
  ...
  info.innerHTML = 
    ...
    '<span id="__uvd_title__" style="color:#ff6bb5;text-decoration:underline;cursor:pointer;">' + escapeHtml(pageInfo.title) + '</span> ' +
    '<span style="color:var(--text3);">(sửa)</span><br>' +
    '<span style="color:var(--text2);">Referer: </span>' +
    '<span id="__uvd_referer__" style="color:#ffb3e6;font-family:monospace;text-decoration:underline;cursor:pointer;font-size:11px;">' + escapeHtml(pageInfo.referer) + '</span><br>' +
    '<span style="color:var(--text2);">Play selector: </span>' +
    '<span id="__uvd_playsel__" style="color:#ffb3e6;font-family:monospace;text-decoration:underline;cursor:pointer;font-size:11px;">' + escapeHtml(savedPlaySel || '(chưa đặt · bấm để thêm)') + '</span>';
...
function buildStreamCardHTML(item, i) {
  ...
  if (item.type === 'BLOB') {
    actionsHtml =
      '<button class="uvd-btn uvd-btn-sm" data-action="play" data-url="' + encodeURIComponent(item.url) + '" data-type="' + escapeHtml(item.type) + '" style="background:rgba(255,107,181,0.25);">Xem</button>' +
...
function showCommandPicker(url, type) {
  ...
  opts.forEach(function(opt) {
    ...
    card.innerHTML = '<div style="font-weight:600;color:#ff6bb5;">' + escapeHtml(opt.label) + '</div><div class="uvd-url-box">' + escapeHtml(opt.value) + '</div>';
    var btn = document.createElement('button');
    btn.className = 'uvd-btn uvd-btn-sm';
...
function showQualityPicker(url) {
  ...
  parseM3U8Master(url, function(qualities) {
    ...
    qualities.forEach(function(q) {
      ...
      playBtn.style.background = 'rgba(255,107,181,0.25)';
...
function renderClickedButtons(container) {
  ...
  var html =
    '<div class="uvd-card">' +
      ...
      '<div style="font-size:12px;color:var(--text2);margin-bottom:10px;">Bật/tắt để chặn hoặc cho phép click lại. Nút bị chặn sẽ tự bỏ qua ở lần Auto Play kế tiếp trên site <span style="color:#ffb3e6;font-family:monospace;">' + escapeHtml(host) + '</span>.</div>';
...
function renderSettings(container) {
  ...
  container.innerHTML =
    ...
    '<div class="uvd-card uvd-timeline-card">' +
      ...
      '<div class="uvd-callout"><span class="uvd-callout-icon">💡</span><span>Từ lần sau, bạn chỉ cần gõ tên bookmark (<strong style="color:#ff6bb5;">UMP DL</strong>) vào thanh địa chỉ rồi chọn nó để kích hoạt. Script luôn tự động cập nhật phiên bản mới nhất.</span></div>' +
    '</div>' +
    ...
    '<div class="uvd-card uvd-timeline-card">' +
      ...
      '<div class="uvd-step"><span class="uvd-step-num">•</span><span class="uvd-step-text">Chọn stream và bấm <strong style="color:#ff6bb5;">Xem</strong> để mở player overlay</span></div>' +
      '<div class="uvd-step"><span class="uvd-step-num">•</span><span class="uvd-step-text">Trong player: thanh công cụ gồm <strong style="color:#ff6bb5;">Chất lượng</strong>, <strong style="color:#ff6bb5;">Tốc độ (+/-)</strong>, <strong style="color:#ff6bb5;">Toàn màn hình</strong>, <strong style="color:#ff6bb5;">PiP</strong>, <strong style="color:#ff6bb5;">Hẹn giờ</strong>, <strong style="color:#ff6bb5;">Boost</strong>, <strong style="color:#ff6bb5;">Mute</strong>, <strong style="color:#ff6bb5;">📷 Screenshot</strong>, <strong style="color:#ff6bb5;">📌 Ghim</strong></span></div>' +
      ...
      '<div class="uvd-callout"><span class="uvd-callout-icon">▶</span><span>Nút <strong style="color:#ff6bb5;">▶</strong> trên header: tự động bấm giúp các nút Play ẩn để link stream lộ ra. Nếu không ăn, đặt CSS selector riêng ở dòng "Play selector".</span></div>' +
    '</div>' +
    ...
    '<div class="uvd-card uvd-timeline-card">' +
      ...
      '<div class="uvd-step"><span class="uvd-step-num">2</span><span class="uvd-step-text">Mở tab <strong style="color:#ff6bb5;">Streams</strong>, chọn stream cần tải</span></div>' +
      '<div class="uvd-step"><span class="uvd-step-num">3</span><span class="uvd-step-text">Bấm <strong style="color:#ff6bb5;">Lệnh tải</strong> → chọn lệnh phù hợp, sao chép</span></div>' +
...
// ========== START ==========
buildUI();
console.log('V' + VERSION + ' UMP DL PRO - tối ưu hiệu năng + giao diện hồng tím');
