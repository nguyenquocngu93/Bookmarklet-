...
.uvd-help-section h4 {
  color:var(--accent); margin:0 0 6px 0; font-size:14px;
}

.uvd-help-section .cmd-box {
  background:rgba(0,0,0,0.5); border-radius:var(--radius-sm); padding:10px;
  font-family:monospace; font-size:11px; word-break:break-all;
  color:var(--text2); border:1px solid rgba(255,255,255,0.04);
  margin:4px 0 8px 0;
}

.uvd-help-section p { margin:4px 0; font-size:13px; color:var(--text2); line-height:1.6; }
.uvd-help-section code { color:var(--accent2); background:rgba(0,0,0,0.3); padding:1px 6px; border-radius:4px; font-size:12px; }
`;
